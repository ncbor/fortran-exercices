program orbitas_elipse
  ...
  do l = 10, 80, 10
    ...
    y=0.0d0;vx=0.0d0;
    x=a*(e+1)
    vy=sqrt(gms/a)*sqrt((1.0d0-e)/(1.0d0+e))
    write(l,*)x, y
    write(l+1,*)vx, vy
    ...
    do i=1,N
      ...
      if(y.lt.0)then
        do j=1,N
          ...
          write(l+1,*)vx, vy
          if(y.gt.0)then
            write(17,*)nome, a, sqrt(gms/a)*sqrt((1.0d0-e)/(1.0d0+e)), (i+j)*h, ((i+j)*h)**2/a**3
            exit
          end if
        end do
        exit
